            ...
            messages=[
                {
                    ...
                    "content": [
                        ...
                        {
                            "type": "text",
                            "text": f"Make a {food_adjectives[random.randint(0, 99)]} recipe for the ingredients that you see in this image. Don't worry about using all the ingredients. Just say the recipe, no preamble. Return as json with fields of ingredients (array), steps (array)"
                        }
                    ],
                }
            ],
